...
1~4枚目の画像がパーツの画像で、5枚目と6枚目がそれらを並べて制作したレイアウト例のイラストです。`
    },
    {
        id: 14,
        category: category[2],
        image: ['./images/works/illust01.jpg',],
        displayImage: 0,
        title: 'ON STAGE',
        subtitle: 'Vtuberの朝ノ瑠璃さんのファンアートです。',
        tools: ['CLIP STUDIO PAINT',],
        time: '約40時間',
        scopes: ['イラスト制作',],
        url: false,
...
1~4枚目の画像がパーツの画像で、5枚目と6枚目がそれらを並べて制作したレイアウト例のイラストです。`
    },
    {
        id: 15,
        category: category[2],
        image: ['./images/works/illust02.jpg',],
        displayImage: 0,
        title: '飛翔',
        subtitle: 'デスクトップ背景用に描いたオリジナルイラストです。',
        tools: ['CLIP STUDIO PAINT',],
        time: '約40時間',
        scopes: ['イラスト制作',],
        url: false,
